...
<html>
<head>
    <title>Welcome to childExtension</title>
    <link rel="stylesheet" href="<c:url value="/static/childExtension-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "childExtension" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/childExtension-items.xml</b> - here you can model your items</li>
            <li><b>resources/childExtension-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/childExtension-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/childExtension-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/childExtension-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
