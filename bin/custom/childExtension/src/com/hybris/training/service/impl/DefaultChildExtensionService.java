...
public class DefaultChildExtensionService implements ChildExtensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultChildExtensionService.class);
	...
	{
		return DefaultChildExtensionService.class.getResourceAsStream("/childExtension/sap-hybris-platform.png");
	}
