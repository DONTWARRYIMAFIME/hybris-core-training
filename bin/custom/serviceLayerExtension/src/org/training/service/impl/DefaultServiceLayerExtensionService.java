...
public class DefaultServiceLayerExtensionService implements ServiceLayerExtensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultServiceLayerExtensionService.class);
	...
	{
		return DefaultServiceLayerExtensionService.class.getResourceAsStream("/serviceLayerExtension/sap-hybris-platform.png");
	}
