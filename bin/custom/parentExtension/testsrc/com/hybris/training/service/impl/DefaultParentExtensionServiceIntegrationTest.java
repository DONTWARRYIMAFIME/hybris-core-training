...
import com.hybris.training.service.impl.DefaultParentExtensionService;
 ...
 */
@IntegrationTest
public class DefaultParentExtensionServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "parentExtensionPlatformLogo";

		// when
		final String logoUrl = parentExtensionService.getHybrisLogoUrl(logoCode);
