...
public class DefaultParentExtensionService implements ParentExtensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultParentExtensionService.class);
	...
	{
		return DefaultParentExtensionService.class.getResourceAsStream("/parentExtension/sap-hybris-platform.png");
	}
