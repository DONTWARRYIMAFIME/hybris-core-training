...
<html>
<head>
    <title>Welcome to parentExtension</title>
    <link rel="stylesheet" href="<c:url value="/static/parentExtension-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "parentExtension" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/parentExtension-items.xml</b> - here you can model your items</li>
            <li><b>resources/parentExtension-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/parentExtension-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/parentExtension-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/parentExtension-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
